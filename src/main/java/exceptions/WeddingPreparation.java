...
public class WeddingPreparation {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Wheather issue: "+e.getMessage());
    ...
    public static void prepareAndGoToWedding() throws BirdPoopException, RainException {
        System.out.println("Put on the suit and started heading to the wedding...");
        boolean hasUmbrella = checkForUmbrella();
        if (!hasUmbrella){
            boolean isRainig = simulateRain();
            if(isRainig){
    ...
    public static boolean simulateRain() {
        ...
        System.out.println("Umbrella status: " + (isRaining ? "Raining" : "Clear sky"));
        return isRaining;
    }
